  ...
  return (
    <div>
      ...
      <p className="text-sm text-gray-600">
        Get Started with the personal information section.
      </p>
        ...
        <label>
          {data.image ? (
            <img
              ...
              alt="User-image"
              className="w-16 h-16 rounded-full object-cover cursor-pointer mt-5 ring ring-slate-300 hover:opacity-80"
            />
          ) : (
            <div className="inline-flex items-center gap-2 text-slate-600 hover:text-slate-700 cursor-pointer mt-5">
