...
const ExperienceForm = ({ data, onChange }) => {
  ...
  const generateDescription = async (index) => {
    ...
    Enhance the following job description for ATS optimization:
    ...
    Write 4–6 well-structured sentences.
    Each sentence MUST end with a period (.)
    Use strong action verbs and highlight measurable achievements.
    Return ONLY the final polished paragraph.`;
