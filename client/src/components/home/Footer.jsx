...
const Footer = () => {
  return (
    <>
      <footer className="flex flex-col justify-center mt-30 overflow-hidden gap-2 md:gap-4 py-16 px-6 md:px-16 lg:px-24 xl:px-32 pb-6 text-[13px] text-gray-500 bg-linear-to-r from-white via-green-200/60 to-white">
            ...
            <div className="flex items-center gap-4 mt-3">
              <a href="https://facebook.com/" target="_blank" rel="noreferrer">
                <svg
                  ...
                  className="lucide lucide-facebook size-5 hover:text-green-500"
                  aria-hidden="true"
                >
        ...
        <p className="text-center">© 2025 Resume Builder</p>
      </footer>
    </>
  );
};
